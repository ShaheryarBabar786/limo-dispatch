      ...
      <Tabs defaultValue={features[0].title} className="w-full">
        <div className="grid grid-cols-1 md:grid-cols-12 gap-12">
          ...
          <div className="md:col-span-5 space-y-3">
            <TabsList className="flex flex-col w-full bg-transparent h-auto p-0">
          ...
          >
            {carData.map((car) => (
              <div key={car.id} className="w-full flex-shrink-0 px-2">
                ...
                <div className="rounded-xl overflow-hidden shadow-2xl transition-all duration-300 hover:shadow-3xl border border-gray-700">
                  ...
                  <div className="p-5"> {/* Reduced padding */}
                    ...
                    <Button className="w-auto px-6 bg-gradient-to-r from-green-600 to-green-700 
  hover:from-green-700 hover:to-green-800 
  text-white py-3 text-sm font-semibold rounded-lg 
  transition-all duration-300 transform hover:scale-105 mx-auto block">
  Get Instant Quote
</Button>
          ...
          <button
  onClick={prevCar}
  className="absolute left-3 top-[45%] transform -translate-y-1/2 bg-gray-800/90 
  hover:bg-gray-700 text-white p-2 rounded-full shadow-lg transition-all duration-300 
...
<button
  onClick={nextCar}
  className="absolute right-3 top-[45%] transform -translate-y-1/2 bg-gray-800/90 
  hover:bg-gray-700 text-white p-2 rounded-full shadow-lg transition-all duration-300 
  hover:scale-110 border border-gray-700"
>
