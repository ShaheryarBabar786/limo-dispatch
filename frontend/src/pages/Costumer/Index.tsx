  ...
  return (
    <div className="min-h-screen bg-black text-foreground">
      ...
      <motion.section 
        ...
        className="relative px-4 pt-25 pb-20 min-h-screen flex items-center justify-center"
        style={{
      ...
      >
        ...
        <div className="container relative z-10">
          ...
          <div className="max-w-4xl relative z-10">
            <h1 className="text-5xl md:text-7xl font-bold mb-6 tracking-tight text-left text-white">
            ...
            <motion.p 
              ...
              className="text-xl md:text-2xl text-gray-200 mb-10 max-w-2xl text-left leading-relaxed"
            >
